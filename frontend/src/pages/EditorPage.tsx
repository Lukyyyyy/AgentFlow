...
const EditorPage = () => {
  ...
  const availableLlmConfigs = llmGlobalConfigs.filter((config) =>
    !!config.model?.trim()
    && (isGenericLlmNode
      || isLegacyReActNode
      || normalizeProviderKey(config.provider) === selectedNodeProvider)
  );
    ...
    <div className="workflow-editor-shell">
      ...
      <header className="workflow-topbar">
        <div className="workflow-title-group">
          <BrandLogo compact className="workflow-brand-logo" />
          ...
          <Input
            ...
            aria-label="工作流名称"
            title="点击编辑工作流名称"
            suffix={<EditOutlined className="workflow-name-edit-icon" aria-hidden="true" />}
          />
          <Select
            value={engineType}
        ...
        <div className="workflow-actions">
          <div className="workflow-action-group workflow-resource-actions">
            <LLMConfigModal />
            <Button
          ...
          <span className="workflow-toolbar-separator" aria-hidden="true" />
          <div className="workflow-action-group workflow-file-actions">
            <Button
              icon={<PlusOutlined />}
