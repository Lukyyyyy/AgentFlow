...
public class JwtSecretProvider {
    ...
    private static final Set<String> WEAK_JWT_SECRETS = Set.of(
            "agentflow-one-jwt-secret-key-change-me-to-a-long-random-string",
            "agentflow-dev-jwt-secret-key-only-for-development",
            "secret",
            "password",
            "123456",
            "jwt-secret",
    ...
    public JwtSecretProvider(
            ...
            @Value("${agentflow.auth.jwt-secret:}") String configuredSecret,
